...
const audioWaka = new Audio('./media/waka.mp3');
const audioVictory = new Audio('./media/victory.mp3');
        ...
        setInterval(function() {
            ...
            if(state == "pacman" && countpac < 650) {
                ...
                if(state == "pacman" &&  (countpac%20  == 10 || countpac%20  == 0)){
                    ...
                    const pacman = document.getElementById('pacman');
                    pacman.setAttribute('src',  "./media/pacman3.png");
                }
                ...
                if(state == "pacman" &&  countpac%20  == 0){
                    ...
                    const pacman = document.getElementById('pacman');
                    pacman.setAttribute('src',  "./media/pacman1.png");
                }
            ...
            if(state == "pacman"){
                if(posPac == 1*200){
                    factory1.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 2*200){
                    factory2.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 3*200){
                    factory3.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 4*200){
                    factory4.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 5*200){
                    factory5.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 6*200){
                    factory6.setAttribute('src',  "./media/tree.png");
                }
                if(posPac == 7*200){
                    factory7.setAttribute('src',  "./media/tree.png");
                }
                if(posPac >= 8*200 && !audioWaka.paused){
                    factory8.setAttribute('src',  "./media/tree.png");
